...
const at=t=>(e,i)=>{void 0!==i?i.addInitializer((()=>{customElements.define(t,e)})):customElements.define(t,e)},lt="lg-remote-control",ct="lg-remote-control-editor";function ht(t,e){let i=Object.keys(t.entities).filter((i=>t.entities[i].platform===e));const o=/media_player/;return i.filter((t=>o.exec(t)))}const dt=new Map(Object.entries({anthemav:{friendlyName:"Anthem A/V Receivers"},arcam_fmj:{friendlyName:"Arcam FMJ Receivers"},denonavr:{friendlyName:"Denon, Marantz A/V Receivers"},heos:{friendlyName:"Denon heos A/V Receivers"},harman_kardon_avr:{friendlyName:"Harman Kardon AVR"},monoprice:{friendlyName:"Monoprice 6-Zone Amplifier"},onkyo:{friendlyName:"Onkyo A/V Receivers"},sonos:{friendlyName:"Sonos"},pws66i:{friendlyName:"Soundavo WS66i 6-Zone Amplifier"},yamaha:{friendlyName:"Yamaha Network Receivers"}}));let ut=class extends st{static get properties(){return{hass:{},_config:{}}}setConfig(t){this._config=t}configChanged(t){const e=Object.assign({},this._config);e[t.target.name.toString()]=t.target.value,this._config=e;const i=new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0});this.dispatchEvent(i)}configChangedBool(t){const e=t.target.name,i="true"===t.target.value,o=Object.assign({},this._config);o[e]=i,this._config=o;const n=new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0});this.dispatchEvent(n)}colorsConfigChanged(t){var e,i;if("HA-ICON"===t.target.tagName){const i=t.target.getAttribute("data-input-name");if(i){const t=this.shadowRoot.querySelector(`[name="${i}"]`);if(t){t.value="";const o=Object.assign({},this._config);o.colors=Object.assign({},null!==(e=o.colors)&&void 0!==e?e:{}),o.colors[i]="",this._config=o;const n=new CustomEvent("config-changed",{detail:{config:o},bubbles:!0,composed:!0});this.dispatchEvent(n)}}}else{const e=Object.assign({},this._config);e.colors=Object.assign({},null!==(i=e.colors)&&void 0!==i?i:{}),e.colors[t.target.name.toString()]=t.target.value,this._config=e;const o=new CustomEvent("config-changed",{detail:{config:e},bubbles:!0,composed:!0});this.dispatchEvent(o)}}_erase_av_receiver(){this._config.av_receiver_family="",this.requestUpdate()}dimensionsConfigChanged(t){var e;const i=Object.assign({},this._config);i.dimensions=Object.assign({},null!==(e=i.dimensions)&&void 0!==e?e:{}),"border_width"===t.target.name?i.dimensions[t.target.name]=t.target.value+"px":i.dimensions[t.target.name]=t.target.value,this._config=i;const o=new CustomEvent("config-changed",{detail:{config:i},bubbles:!0,composed:!0});this.dispatchEvent(o)}getLgTvEntityDropdown(t){let e=ht(this.hass,"webostv"),i=B``;return""!=this._config.tventity&&e.includes(t)||(i=B`<option value="" selected> - - - - </option> `),B`
        ...
        `}setRepeatConfig(t){var e,i,o,n,s,r,a;const l=null!==(e=null==t?void 0:t.delay)&&void 0!==e?e:400,c=null!==(i=null==t?void 0:t.interval)&&void 0!==i?i:150,h=null!==(o=null==t?void 0:t.volume_delay)&&void 0!==o?o:l,d=null!==(n=null==t?void 0:t.volume_interval)&&void 0!==n?n:c,u=null!==(a=null!==(s=null==t?void 0:t.debug)&&void 0!==s?s:null===(r=this._config)||void 0===r?void 0:r.debug)&&void 0!==a&&a,p=void 0!==(null==t?void 0:t.volume_delay)||void 0!==(null==t?void 0:t.volume_interval);return B`
          <div class="heading">Button Hold Repeat:</div>
          <br>
          <label for="repeat_delay">D-pad hold delay: ${l}ms</label><br>
          <input type="range" min="100" max="1000" step="50" .value="${l}" id="repeat_delay" name="delay" @input=${this.repeatConfigChanged} style="width: 40ch;">
          </input>
          <br>
          <br>
   ...
   `:B``}static get styles(){return r`
        ...
        `}function _t(){return B`<svg version="1.0" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        `}function vt(){return B`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              <style type="text/css">
                .st0{fill:var(--remote-text-color);}
              </style>
        ...
        `,amazon:vt()}}static get properties(){return{hass:{},config:{},_show_inputs:{},_show_sound_output:{},_show_text:{},_show_keypad:{},_show_vol_text:{},volume_value:{type:Number,reflect:!0},output_entity:{type:Number,reflect:!0}}}constructor(){super(),this.homeisLongPress=!1,this._directionHoldTimer=null,this._directionRepeatTimer=null,this._directionIsRepeating=!1,this._activeDirection=null,this._ignoreNextClickUntil=0,this._volumeHoldTimer=null,this._volumeRepeatTimer=null,this._volumeIsRepeating=!1,this._activeVolumeService=null,this._ignoreVolumeClickUntil=0,this._show_inputs=!1,this._show_sound_output=!1,this._show_text=!1,this._show_keypad=!1,this._show_vol_text=!1,this.volume_value=0,this.soundOutput=""}render(){const t=this.hass.states[this.config.entity],e=this.config.color_buttons,i=this.config.dimensions&&this.config.dimensions.border_width?this.config.dimensions.border_width:"1px",o=this.config.dimensions&&this.config.dimensions.scale?this.config.dimensions.scale:1,n=Math.round(260*o)+"px",s=this.config.tv_name_color?this.config.tv_name_color:"var(--primary-text-color)",r=this.config.colors&&this.config.colors.background?this.config.colors.background:"var( --ha-card-background, var(--card-background-color, white) )",a=this.config.colors&&this.config.colors.border?this.config.colors.border:"var(--primary-text-color)",l=this.config.colors&&this.config.colors.buttons?this.config.colors.buttons:"var(--secondary-background-color)",c=this.config.colors&&this.config.colors.text?this.config.colors.text:"var(--primary-text-color)",h=this.config.mac;return!this.config.ampli_entity||"external_arc"!==this.hass.states[this.config.entity].attributes.sound_output&&"external_optical"!==this.hass.states[this.config.entity].attributes.sound_output?(this.volume_value=Math.round(100*this.hass.states[this.config.entity].attributes.volume_level),this.output_entity=this.config.entity):(this.volume_value=Math.round(100*this.hass.states[this.config.ampli_entity].attributes.volume_level*2)/2,this.output_entity=this.config.ampli_entity),B`
            <div class="card">
                <div class="page" style="box-sizing: border-box; --remote-button-color: ${l}; --remote-text-color: ${c}; --remote-color: ${r}; --remotewidth: ${n};  --main-border-color: ${a}; --main-border-width: ${i}">
                    ${this.config.name?B` <div class="tv_title" style="color:${s}" >${this.config.name}</div> `:""}
                    <div class="grid-container-power"  style="--remotewidth: ${n}">
                        <button class="btn-flat flat-high ripple" @click=${()=>this._channelList()}><ha-icon icon="mdi:format-list-numbered"/></button>
                        ${["off","unavailable"].includes(t.state)?B`
                            <button class="btn ripple" @click=${()=>this._media_player_turn_on(h)}><ha-icon icon="mdi:power" style="color: ${c};"/></button>
                        `:B`
                    ...
                    ${this._show_inputs?B`
                        ...
                        <div class="grid-container-input">
                            ...
                            <div class="grid-item-input">
                                ${t.attributes.source_list.map((e=>B`
        ...
        `}</button>
                                    <button class="${"tv_speaker_headphone"===t.attributes.sound_output?"btn_sound_on tv-phone bnt_sound_icon_width":"btn_sound_off tv-phone bnt_sound_icon_width ripple overlay"}" style="margin-left: calc(var(--remotewidth) / 7.5);" @click=${()=>this._select_sound_output("tv_speaker_headphone")}>${B`
            <svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 567 171" style="enable-background:new 0 0 567 171;" xml:space="preserve">
              <style type="text/css">
              .st0{fill:var(--remote-text-color);}
            ...
            <g transform="translate(0.000000,150.000000) scale(0.100000,-0.100000)">
              ...
              c0,88-2,101-24,128l-24,30l-206,3C2854.2,776,2814.2,774,2810.2,762z"/>
                ...
                <path class="st0" d="M3305.2,640V515h50h50v125v125h-50h-50V640z"/>
                                    ...
                                    <button class="${"lineout"===t.attributes.sound_output?"btn_sound_on line bnt_sound_icon_width":"btn_sound_off line bnt_sound_icon_width ripple overlay"}" style="margin-right: calc(var(--remotewidth) / 7.5);" @click=${()=>this._select_sound_output("lineout")}>${B`
  ...
  `}</button>
                        ...
                        `:B`
                            <div class="grid-container-source">
                                ...
                                <button class="btn_source ripple" @click=${()=>this._select_source("Prime Video")}>${vt()}</button>
