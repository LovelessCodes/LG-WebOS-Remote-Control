  ...
  render() {
    ...
    const borderWidth =
      this.config.dimensions && this.config.dimensions.border_width
        ...
        : "1px";
    const scale =
      this.config.dimensions && this.config.dimensions.scale ? this.config.dimensions.scale : 1;
    const remoteWidth = Math.round(scale * 260) + "px";
    const tv_name_color = this.config.tv_name_color
      ? this.config.tv_name_color
      ...
      <div class="card">
        ...
        >
          ${
            this.config.name
              ? html`
                  <div class="tv_title" style="color:${tv_name_color}">${this.config.name}</div>
                `
              : ""
          }
